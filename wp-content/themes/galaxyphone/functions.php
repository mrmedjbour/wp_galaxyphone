...
function gp_assets() {
    ...
    // Main CSS File
    wp_enqueue_style( 'galaxyphone', get_stylesheet_uri(), array('bootstrap'), '1.0', 'all' );
    ...
    wp_enqueue_script( 'galaxyphone-js', get_theme_file_uri('assets/js/main-script.js'), array('jquery','jquery-ui-core','jquery-ui-selectmenu'), '1.0', true );
